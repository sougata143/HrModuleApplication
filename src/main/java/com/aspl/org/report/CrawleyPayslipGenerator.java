...
public class CrawleyPayslipGenerator {
	...
	static String fileName = "crawley-payslip-new";
	...
	static String reportName 		   	= "STAFF PAY SLIP FOR JUNE 2019";
	static String netPayAmount 			= "16353.00";
	static String netPayAmountInWords   = "SIXTEEN THOUSAND THREE HUNDRED FIFTY THREE";
	...
	public static PdfPTable createHeader2(String fromDate, String toDate, String payslipMonth, Integer payslipYear) throws DocumentException {
		...
		Paragraph para_1 = new Paragraph();
		para_1.add(new Chunk("STAFF PAY SLIP FOR " + payslipMonth.toUpperCase() + " " + payslipYear, Font8Bold));
		para_1.add(Chunk.NEWLINE);
		para_1.setSpacingBefore(50);
		para_1.setSpacingAfter(50);
	...
	public static PdfPTable createEmployeeDetailsLine4(String dateofjoining, String esiNo) throws DocumentException {
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_2: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(dateofjoining.toString(), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
	...
	public static PdfPTable createEmployeeDetailsLine7(Integer days_for_pay) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
	...
	public static PdfPTable createEarningDetailsLine1(Double basicsalary, Double esicontribution) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_1: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Basic Salary", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("ESI Amount", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	...
	public static PdfPTable createEarningDetailsLine2(Double houserentforworker, Double salaryAdv) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_1: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("House Rent Allowence", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_2: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(houserentforworker), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	...
	public static PdfPTable createEarningDetailsLine3(Double otamount, Double pfcontribution) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
	...
	public static PdfPTable createEarningDetailsLine4(Double incTax) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Income Tax", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_4: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(incTax), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	...
	public static PdfPTable createEarningDetailsLine5(Double canteenCharge) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
	...
	public static PdfPTable createEarningDetailsLine6(Double profTax) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
	...
	public static PdfPTable createEarningDetailsLine7(Double welFund) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Wel. Fund (JUN/DEC)", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	...
	public static PdfPTable createEarningDetailsLine8(Double hrRecovary) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("H.R. RECVR", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	...
	public static PdfPTable createEarningDetailsLine9(Double fineAmount) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("FINE AMT.", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_4: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(fineAmount), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
