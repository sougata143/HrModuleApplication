...
public class CrawleyESIReportGenerator {
	...
	static String fileName = "crawley-esi-report";
	...
	static String compAddress   = "32, FORESHORE ROAD, HOWRAH 711 103";
	static String register		= "REGISTER OF EMPLOYEES UNDER REGULATION 32";
	static String reportName 	= "STAFF ESI DETAILS FOR THE MONTH OF ";
	...
	public static void main(String[] args) throws DocumentException, IOException {
		...
		PdfPTable header2 = createHeader2(reportName);
...
//		PdfPTable carryFwdLine = createCarryFwdLine();
//		document.add(carryFwdLine);
...
//		("Report Name : " + reportName + "\nPDF has been generated successfully in this path : \n" + RESULT);
	...
	public static PdfPTable createHeader1() throws DocumentException {
		...
		para_1.add(new Chunk(compAddress, Font9Bold));
		para_1.add(Chunk.NEWLINE);
		para_1.add(new Chunk(register, Font9Bold));
		para_1.add(Chunk.NEWLINE);
	...
	public static PdfPTable createHeader2(String month) throws DocumentException {
		...
		Paragraph para_1 = new Paragraph();
		para_1.add(new Chunk("ESI Contribution Report For the Month of "+month.toUpperCase()+ " "+LocalDate.now().getYear(), Font8Bold));
		para_1.add(Chunk.NEWLINE);
	...
	public static PdfPTable createDescriptionTableHead1() throws DocumentException {
		...
		dataTable.setWidths(new float[]{1, 2, 4, 3, 3, 3, 3});
		
		String[] headersLabels = {"SNO","ESI NO.","NAME","DATE OF APP. \n(IF WITHIN THE MONTH)","NO. OF DAYS \nFOR WHICH WAGES PAID/PAYABLE","TOTAL AMT. \nOF WAGES PAID/PAYABLE","EMPLOYEES SHARE \nOF CONTRIBUTION"};
	...
	public static PdfPTable createDescriptionTable(int i, String esiNo, String empName, Integer noOfDays, Double totalAmt, Double Contribution) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(7);
...
//		for(int i=1; i<=56; i++) {
			...
			cell_5: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(noOfDays), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			cell_6: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(totalAmt), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
			...
			cell_7: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(Contribution), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.RIGHT);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
...
//		}
	...
	public static PdfPTable createCarryFwdLine(Double totalAmt, Integer totalDays, Double totalContribution) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(7);
		...
		cell_3: {
			...
			Paragraph para_2 = new Paragraph();
			para_2.add(new Chunk("C/F TO NEXT PAGE : ", Font7Bold));
			cell = new PdfPCell(para_2);
			cell.setPadding(3);
			// cell.setBorder(Rectangle.NO_BORDER);
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		...
		cell_5: {
			...
			Paragraph para_2 = new Paragraph();
			para_2.add(new Chunk(String.valueOf(totalDays), Font7Bold));
			cell = new PdfPCell(para_2);
			cell.setPadding(3);
			// cell.setBorder(Rectangle.NO_BORDER);
			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		...
		cell_6: {
			...
			Paragraph para_2 = new Paragraph();
			para_2.add(new Chunk(String.valueOf(totalAmt), Font7Bold));
			cell = new PdfPCell(para_2);
			cell.setPadding(3);
			// cell.setBorder(Rectangle.RIGHT);
			cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		...
		cell_7: {
			...
			Paragraph para_2 = new Paragraph();
			para_2.add(new Chunk(String.valueOf(totalContribution), Font7Bold));
			cell = new PdfPCell(para_2);
			cell.setPadding(3);
			// cell.setBorder(Rectangle.RIGHT);
			cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
