...
public class CrawleyLabourWelfareReportGenerator {
	...
	static String fileName = "crawley-labour-welfare-report";
	...
	static String reportName 	= "STATEMENT OF EMPLOYEES & LABOUR WELFARE FUND CONTRIBUTION";
	static String asOnDate		= "AS ON 30/08/2019";
...
//		("Report Name : " + reportName + "\nPDF has been generated successfully in this path : \n" + RESULT);
	...
	public static PdfPTable createHeader2() throws DocumentException {
		...
		para_1.add(Chunk.NEWLINE);
		para_1.add(new Chunk(asOnDate, Font8Bold));
	...
	public static PdfPTable createDescriptionTableHead1() throws DocumentException {
		...
		dataTable.setWidths(new float[]{1, 4, 2, 2, 2});
		
		String[] headersLabels = {"SNO","NAME","DESIGNATION","GROSS WAGES","CONTRIBUTION TO LABOUR WELFARE FUND"};
	...
	public static PdfPTable createDescriptionTable() throws DocumentException {
		...
		for(int i=1; i<=58; i++) {
			...
			cell_2: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Pratap Chandra Ghosh", Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Worker", Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			cell_4: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("10846.00", Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
			...
			cell_5: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("3.00", Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
