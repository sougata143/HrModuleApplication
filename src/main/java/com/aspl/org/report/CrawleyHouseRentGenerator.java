...
public class CrawleyHouseRentGenerator {
	...
	static String fileName = "crawley-workers-house-rent";
	...
	static String reportName 		   	= "WORKERS HOUSE RENT FOR THE MONTH OF JUNE 2019";
	static String netPayAmount 			= "505.74";
	static String netPayAmountInWords   = "FIVE HUNDRED FIVE AND SEVENTY FOUR PAISE";
...
//		("Report Name : " + reportName + "\nPDF has been generated successfully in this path : \n" + RESULT);
	...
	public static PdfPTable createHeader2(String fromDate, String toDate, String payslipMonth, Integer payslipYear) throws DocumentException {
		...
		Paragraph para_1 = new Paragraph();
		para_1.add(new Chunk("WORKERS HOUSE RENT FOR THE MONTH OF " +  payslipMonth.toUpperCase() + " " + payslipYear, Font8Bold));
		para_1.add(Chunk.NEWLINE);
		para_1.setSpacingBefore(50);
		para_1.setSpacingAfter(50);
	...
	public static PdfPTable createEmployeeDetailsLine3(String pfNo, String bankAcNo) throws DocumentException {
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_2: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(pfNo, Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
	...
	public static PdfPTable createEmployeeDetailsLine5(Integer holiday, String empLocation) throws DocumentException {
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_2: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(holiday), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
	...
	public static PdfPTable createEmployeeDetailsLine7(Double otHrs, Integer days_for_pay) throws DocumentException {
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_2: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(otHrs.toString(), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
	...
	public static PdfPTable createEarningDetailsLine1(Double basicsalary, Double normalwagesearned, Double houserentforworker) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_2: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(basicsalary.toString(), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Total For ESI", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_4: {
				...
				Paragraph para_2 = new Paragraph();
				Double totalForESI = normalwagesearned + houserentforworker; // Total for ESI Calculation
				para_2.add(new Chunk(totalForESI.toString(), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	...
	public static PdfPTable createEarningDetailsLine2(Double normalwagesearned, Double esicontribution) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_1: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Cumulative Wages", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("ESI Cont.", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_4: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(esicontribution), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	...
	public static PdfPTable createEarningDetailsLine3(Double otamount, Double canteenCharge) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_1: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("OT Cumulative", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Canteen Charges", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_4: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(canteenCharge), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	...
	public static PdfPTable createEarningDetailsLine4(Double profTax) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Professional Tax", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_4: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(profTax), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	...
	public static PdfPTable createEarningDetailsLine5(Double welFund) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("Wel. Fund (June/Dec.)", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_4: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(welFund), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	...
	public static PdfPTable createEarningDetailsLine6(Double hrRecovary) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		//////////////////////////////////////////////////////////////////////////
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("House Rent Recvr", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_4: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(hrRecovary), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	...
	public static PdfPTable createGrossEarningDetailsLine(Double houserentforworker, Double grossdeduction) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(4);
		...
		///////////////////////////////////////////////////////////////////...///////
			...
			cell_1: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("HOUSE RENT", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell_2: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(houserentforworker), Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk("TOTAL DEDUCTION", Font7Bold));
				cell = new PdfPCell(para_2);
				cell.setPadding(4);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	...
	public static PdfPTable createPaymentDateLine(String payDate) throws DocumentException {
		...
		cell_2:{
			Paragraph para_1 = new Paragraph();
			para_1.add(new Chunk("" + String .valueOf(payDate), Font8));
			/*para_1.add(Chunk.NEWLINE);
			para_1.setSpacingBefore(50);
			para_1.setSpacingAfter(50);*/
