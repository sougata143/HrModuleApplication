...
public class CrawleyLeaveApplicationReportGenerator {
	...
	static String fileName = "crawley-leave-application-report";
	...
	static String reportName    = "LEAVE APPLICATION FOR DATE OF 01-01-2019 TO 31-12-2019";
...
//		("Report Name : " + reportName + "\nPDF has been generated successfully in this path : \n" + RESULT);
	...
	public static PdfPTable createHeader2(String fromDate , String toDate ) throws DocumentException {
		...
		Paragraph para_1 = new Paragraph();
		para_1.add(new Chunk("LEAVE APPLICATION FOR DATE OF " + String.valueOf(fromDate).split("\\s")[0] + " TO " + String.valueOf(toDate).split("\\s")[0], Font8Bold));
		para_1.add(Chunk.NEWLINE);
	...
	public static PdfPTable createDescriptionTableHead1() throws DocumentException {
		...
		dataTable.setWidths(new float[]{1, 2, 2, 4, 1, 3, 2, 2, 2});
		
		String[] headersLabels = {"SNo","Voucher No","Emp Code","Name","Type","Application Date","From Date","To Date","No of Days"};
	...
	public static PdfPTable createDescriptionTable(Integer SlNo, String voucherNo, String empCode, String empName, String leaveType, Date applicationDate, Date fromDate, Date toDate, Integer noofdays) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(9);
		...
		//for(int i=1; i<=58; i++) {
			...
			cell_2: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(voucherNo, Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			cell_3: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(empCode.toString(), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			cell_5: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(leaveType, Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			cell_6: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(applicationDate).split("\\s")[0], Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
			...
			cell_7: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(fromDate).split("\\s")[0], Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			cell_8: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(toDate).split("\\s")[0], Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			cell_9: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(noofdays.toString(), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
